...
#        self.yr = np.zeros_like(self.t)
    ...
    # -------------------------------------------------------------------------
        ...
        for i in range(0,robot.stateDim):    
            self.state[i,self.currentIndex] = robot.state[i].item()
        # store ctrl data
        for i in range(0,robot.ctrlDim):    
            self.ctrl[i,self.currentIndex] = robot.ctrl[i].item()
    ...
    # -------------------------------------------------------------------------
    def plot(self, figNo = 1, xmin=-5, xmax=5, ymin=-5, ymax=5, mod=None):
    # -------------------------------------------------------------------------
...
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    # -------------------------------------------------------------------------
    def plotFleet(self, figNo = 1, xmin=-5, xmax=5, ymin=-5, ymax=5, mod=None, links=True):
    # -------------------------------------------------------------------------
